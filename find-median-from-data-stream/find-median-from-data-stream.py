class MedianFinder:
    ...
    def __init__(self):
        ...
        self.max_heap=[]    #Stores the smaller numbers
        self.min_heap=[]    #Stores the larger numbers
    ...
    def addNum(self, num: int) -> None:
        ...
        #heapq.heappush maintians heap property
        #heapq.heapify(self.min_heap)
        #heapq.heapify(self.max_heap)
        #TLE on heapifying and appending
        
        #Balanceing the heaps    
